...
@Controller
public class JclMergeController {
	
	@Autowired
	private DataSource dataSource;
	
	@RequestMapping("/jclmerge")
	public String Jcldetail(@RequestParam("jcl_id") String jcl_id, @RequestParam("jcl_num") int jcl_num, Model model) throws SQLException, ClassNotFoundException {
